...
- Когда не понимаешь какой элемент выпирает, например в мобильной версии, и дает горизонтальный скролл:
  ставишь селектору \* свойство { outline: 4px solid green, }
  либо {
  box-sizing: border-box;
  background: rgb(0 100 0/0.005) !Important;
  }
